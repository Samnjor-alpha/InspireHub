...
<!--            <li><a class="nav-link scrollto" href="#team">Team</a></li>-->
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Careers</a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="attachments.php">Apply for Attachment</a></li>
                </ul>
            </li>
    ...
    <a href="#quote" class="get-started-btn scrollto d-none d-lg-inline-block">REQUEST DEMO</a>
